        ...
        <div class="col col-md-9 col-xs-8">
            ...
            <?php
                if(isset($_POST['buscarProd']) && $_POST['txtProd'] != ""){
                  ...
                  $datosPag = $productos->buscarProductos($_POST['txtProd']);
                  // $datosPag  = cProducto::buscarProductos($_POST['txtProd']);
                  if(@$datosPag[0]['CLAVE']){
                      echo'
                      ...
                      for($ren = 0; $ren < count($datosPag); $ren++){
                          echo'
                              <tr>
                                ...
                                <td>'.$datosPag[$ren]["ARTICULO"].'</td>
                                <td>'.$datosPag[$ren]["PRESENTACION"].'</td>
                                <td>'.$datosPag[$ren]["PRECIO"].'</td>
                                <td align="middle"><img src="assests/images/'.$datosPag[$ren]["FOTO"].'" class="img-fluid logo-sys"/></td>
                    ...
                    echo "<h1><p class='bg-info text-center' style='color: white; padding:5px'>¡No hay coincidencias!</p></h1>";
                  }
                }else{
                    echo '<center><img src="assests/images/sistema/lupa.png" class="img-fluid logo-search" alt="Buscar..." title="Buscando"/><br><br><h2>Bienvenido -> Inicia una busqueda</h2></center>';
                }
                echo '</div>';
                require('sidebar.php');
            ?>
