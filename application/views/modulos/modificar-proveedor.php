...
$datos_proveedor = $proveedores->filtrarProveedores($cve);
...
if(isset($_POST["btnGuadar"])){
    ...
    $datos = $proveedores->modificarProveedores($cve, $emp, $tel_s, $tel, $correo, $nom, $apa, $ama);
    if($datos[0]["ID"]== "1") {
        ...
        $datos[0] = 0;
        echo '<script language="javascript">alert("Proveedor no modificado, verificar datos.")</script>';
    }else{
        $datos[0] = 0;
