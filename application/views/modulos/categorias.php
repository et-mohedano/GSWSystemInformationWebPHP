<?php
	...
	$totalRegistro=$categorias->contarCategorias();	
	...
	$datosPag=$categorias->consultarCategorias($inicioPag,$numRegistro);			
    $estado=1;
   
    //VERIFICA QUE LA VARIABLE ne TENGA VALOR PARA ELIMINAR AL USUARIO
    if (isset($_GET['ne'])){
       
       	$datosDel=$categorias->eliminarCategorias($_GET['ne']);	
              ...
              <form id="frmConexion" name="frmConexion" method="POST">
                    ...
                    <?php
                      ...
                      {	          
                    	for($rr=0;$rr<count($datosPag);$rr++){	
                    		echo "<tr>";
                    		echo "<td bg-primary align='middle'><a href='?ruta=modificar-categoria&cve=".$datosPag[$rr]["Clave"]."' class='btn btn-sys' title='Editar' ><i class='fa fa-pencil-square-o'></i></a>
                                <a href='?ruta=categorias&ne=".$datosPag[$rr]["Clave"]."' class='btn btn-sys' title='Eliminar' ><i class='fa fa-times-circle'></i></a></td>";
						...
						{		
							...
							{		
								echo " <a href='?ruta=categorias&pagina=$i'>$i</a> ";
							}
						}
						echo "</center>";
                  		}
                ...
                <hr>
                  <div class="text-center">
                      <a href='?ruta=registrar-categoria' class="btn btn-sys">Registrar Categoria&nbsp;</a>
                      <a href='?ruta=activar-categoria' class="btn btn-sys">Activar Categoria&nbsp;</a>
