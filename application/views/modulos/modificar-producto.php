...
if(isset($_POST["btnGuadar"])){
    ...
    $datos = $productos->modificarProducto($cve, $prov, $pres, $nom, $cant, $cad, $usu, $precio_v, $precio_a, $foto, $ubi, $cat);
    if($datos[0]["ID"]!= "0") {
