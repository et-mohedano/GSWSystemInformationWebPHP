...
$datos_usuario = $usuarios->filtrarUsuario($cve);
$nom = $datos_usuario[0]['NOMBRE'];
$pat = $datos_usuario[0]['PATERNO'];
$mat = $datos_usuario[0]['MATERNO'];
$tel = $datos_usuario[0]['TELEFONO'];
$per = $datos_usuario[0]['PERFIL'];
$pas = $datos_usuario[0]['PASS'];
...
if(isset($_POST["btnGuadar"])){
    ...
    $datos = $usuarios->modificarUsuario($cve, $nom, $pat, $mat, $tel, $per, $pas, $rol);
    if($datos[0]["ID"]== "1") {
